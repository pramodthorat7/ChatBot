...
public class UserThree implements ActionListener, Runnable {
    ...
    UserThree() {
        ...
        JLabel name = new JLabel("Group ABC");
        name.setBounds(110, 15, 100, 18);
        name.setForeground(Color.WHITE);
        name.setFont(new Font("SAN_SERIF", Font.BOLD, 18));
        p1.add(name);

        JLabel status = new JLabel("UserOne, UserTwo, UserFour, UserFive");
    ...
    public void actionPerformed(ActionEvent ae) {
        try {
            String out = "<html><p><b>" + name + "</b></p><p>" + text.getText() + "</p></html>";
            ;
    ...
    public static JPanel formatLabel(String out) {
        ...
        output.setBorder(new EmptyBorder(0, 10, 0, 50));
